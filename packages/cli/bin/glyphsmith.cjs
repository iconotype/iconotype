...
var ICONFONT_EXTENSION = ".glyphsmith.json";
...
function buildCss(project, build2, opts = {}) {
  ...
  if (prefs.showMetadata) {
    out.push(`/* ${family} v${prefs.majorVersion}.${prefs.minorVersion} \u2014 generated by Glyphsmith. Do not edit by hand. */`);
  }
  out.push(
    `@font-face {`,
    `  font-family: '${family}';`,
...
function buildVariables(project, build2, format, opts = {}) {
  ...
  return [
    `// ${family} v${project.preferences.font.majorVersion}.${project.preferences.font.minorVersion} \u2014 generated by Glyphsmith. Do not edit by hand.`,
...
<body>
<h1>${prefs.family}</h1>
<p class="meta">${icons.length} icons \xB7 ${build2.glyphs.length} glyphs \xB7 em ${build2.metrics.unitsPerEm} \xB7 generated by Glyphsmith</p>
...
export class GlyphsmithIcon extends HTMLElement {
...
if (!customElements.get('${tag}')) customElements.define('${tag}', GlyphsmithIcon)
`;
}
...
function buildVariableBlock(project, build2, kind, fontPath) {
  ...
  switch (kind) {
    ...
    case "css-variables":
      return [
        `/* ${project.preferences.font.family} codepoints \u2014 generated by Glyphsmith */`,
        ":root {",
...
// src/cli.ts
var USAGE = `glyphsmith \u2014 icon font toolchain
...
examples:
  glyphsmith init --input icomoon/selection.json --name app       --fonts-dir app/fonts --styles-dir app/css --style-kind scss-variables
